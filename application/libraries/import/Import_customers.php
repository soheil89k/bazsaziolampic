...
class Import_customers extends App_import
{
    ...
    public function __construct()
    {
        ...
        $this->addImportGuidelinesInfo('ردیف های تکراری ایمیل وارد نمی شوند.', true);

        $this->addImportGuidelinesInfo('مطمئن شوید که مجوز پیش فرض مخاطب را در پیکربندی کرده اید <a href="' . admin_url('settings?group=clients') . '" target="_blank">تنظیمات->تنظیمات->مشتری</a> برای دریافت بهترین نتایج مانند اختصاص خودکار مجوزهای تماس و تنظیمات اعلان ایمیل بر اساس مجوز.');
