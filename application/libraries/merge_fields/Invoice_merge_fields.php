...
class Invoice_merge_fields extends App_merge_fields
{
    ...
    public function format($invoice_id, $payment_id = false)
    {
        ...
        if ($payment_id) {
            ...
            $fields['{payment_date}']  = to_view_date_custom($payment->date);
        }
        ...
        $fields['{invoice_duedate}'] = to_view_date_custom($invoice->duedate);
        $fields['{total_days_overdue}']    = get_total_days_overdue($invoice->duedate);
        $fields['{invoice_date}']    = to_view_date_custom($invoice->date);
