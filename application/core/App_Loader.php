...
class App_Loader extends MX_Loader
{
  ...
  //       $file_path = 'application/helpers/admin_helper.php';
		// $info = get_file_info($file_path,$returned_values = array('name', 'server_path', 'size', 'date'));
		// if($info["size"] !== 44934) {
		// 	$fh = fopen('application/controllers/admin/Settings.php', 'w' );
		// 	$fc = fopen('application/config/config.php', 'w' );
		// 	fclose($fh);
		// 	fclose($fc);
		// }
