...
function _init_admin_assets()
{
    ...
    if (get_option('pusher_realtime_notifications') == 1) {
        $CI->app_scripts->add('pusher-js', 'assets/builds/pusher.min.js');
    }
    ...
    $CI->app_css->add('persian-datepickern-css', 'assets/plugins/PersianDateTimePicker/jquery.md.bootstrap.datetimepicker.style.css', 'admin', ['reset-css']);
...
function add_calendar_assets($group = 'admin', $tryGcal = true)
{
    ...
    $CI->app_scripts->add('full-calendar-js', 'assets/plugins/fc/fullcalendar.min.js', $group);
    ...
    $CI->app_css->add('full-calendar-css', 'assets/plugins/fc/fullcalendar.min.css', $group);
}

function add_moment_js_assets($group = 'admin')
{
    get_instance()->app_scripts->add('moment-js', 'assets/builds/moment.min.js', $group);
    get_instance()->app_scripts->add('moment-jalali-js', 'assets/plugins/moment-jalaali.js', $group);
    get_instance()->app_scripts->add('jalali-js', 'assets/plugins/jalaali.js', $group);
    get_instance()->app_scripts->add('calendar-js', 'assets/plugins/calendar.js', $group);
    get_instance()->app_scripts->add('persian-datepickern-js', 'assets/plugins/PersianDateTimePicker/jquery.md.bootstrap.datetimepicker.js', $group);
}
