...
function app_init_customer_profile_tabs()
{
    ...
    $CI->app_tabs->add_customer_profile_tab('whatsapp', [
        'name' => _l('whatsapp_send_coustomerـin'),
        'icon' => 'fa fa-send',
        'view' => 'admin/clients/groups/whatsapp',
        'position' => 5,
    ]);
    ...
    $CI->app_tabs->add_customer_profile_tab('satisfaction', [
        'name' => _l('feedback'),
        'icon' => 'fa fa-question-circle',
        'view' => 'admin/clients/groups/feedback',
        'position' => 66,
    ]);
