...
function get_company_logo($uri = '', $href_class = '', $type = '')
{
    ...
    if ($company_logo != '') {
        $logo = '<a href="' . $logoURL . '" class="logo img-responsive text-center' . ($href_class != '' ? ' ' . $href_class : '') . '" style="display: inline-block;">
        <img src="' . base_url('uploads/company/' . $company_logo) . '" width="150" class="img-responsive" alt="' . html_escape($company_name) . '">
        </a>';
    } elseif ($company_name != '') {
