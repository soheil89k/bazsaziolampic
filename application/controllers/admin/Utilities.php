...
class Utilities extends AdminController
{
    ...
    public function bulk_pdf_exporter()
    {
        ...
        if ($this->input->post()) {
            ...
            $datestart_date = to_sql_date_custom($this->input->post('date-from'));
        	$dateend_date   = to_sql_date_custom($this->input->post('date-to'));

            $this->load->library('app_bulk_pdf_export', [
                'export_type'       => $export_type,
                'status'            => $this->input->post($export_type . '_export_status'),
                'date_from'         => $datestart_date,
                'date_to'           => $dateend_date,
