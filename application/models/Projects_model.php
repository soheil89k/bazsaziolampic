...
class Projects_model extends App_Model
{
    ...
    {
        $due_date = to_sql_date_custom($data['due_date'], true);
        ...
        if ($insert_id) {
            ...
            log_activity('پروژه جدید ایجاد شد [ID:' . $insert_id . ']');
    ...
    public function update_milestone($data, $id)
    {
        ...
        if ($this->db->affected_rows() > 0) {
            ...
            log_activity('پروژه به روز رسانی شد [ID:' . $id . ']');
    ...
    public function add($data)
    {
        ...
        $start_date = to_sql_date_custom($data['start_date']);
        $deadline_date   = to_sql_date_custom($data['deadline']);
        ...
        if ($insert_id) {
            ...
            log_activity('ساخت پروژه [ID: ' . $insert_id . ']');
