        ...
        if ((!empty($email)) and (!empty($password))) {
            ...
            if ($user) {
                ...
                if (!app_hasher()->CheckPassword($password, $user->password)) {
                    ...
                    log_activity('Failed Login Attempt ['.$field.': ' . $email . ', Is Staff Member: ' . ($staff == true ? 'Yes' : 'No') . ', IP: ' . $this->input->ip_address() . ']');
                ...
                log_activity('Non Existing User Tried to Login ['.$field.': ' . $email . ', Is Staff Member: ' . ($staff == true ? 'Yes' : 'No') . ', IP: ' . $this->input->ip_address() . ']');
            ...
            if ($user->active == 0) {
                ...
                log_activity('Inactive User Tried to Login ['.$field.': ' . $email . ', Is Staff Member: ' . ($staff == true ? 'Yes' : 'No') . ', IP: ' . $this->input->ip_address() . ']');
