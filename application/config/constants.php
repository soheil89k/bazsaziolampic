 ...
 */
define('UPDATE_URL', 'https://pegus.ir/perfex_updates/index.php');

/**
 * Get latest version info
 */
define('UPDATE_INFO_URL', 'https://pegus.ir/perfex_updates/update_info.php');
 ...
 * Company attachments, favicon, logo etc..
 */
define('WHATSAPP_FILES_FOLDER', FCPATH . 'uploads/whatsapp' . '/');
/**
