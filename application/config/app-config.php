...
*
*/
define('APP_BASE_URL', 'https://crm.bazsaziolampic.ir/');
...
*/
define('APP_ENC_KEY', '8afbf18c660e6a77ed5425871db7d494');
 ...
 */
define('APP_DB_USERNAME', 'bazsaziolampic_system');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', '4i6h^3-M3U+5');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'bazsaziolampic_crm');
