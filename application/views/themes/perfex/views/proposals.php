        ...
        <?php foreach($proposals as $proposal){ ?>
          <tr>
            <td>
             ...
             <td data-order="<?php echo $proposal['open_till']; ?>"><?php echo format_to_relative_time($proposal['open_till'], '', true); ?></td>
             <td data-order="<?php echo $proposal['date']; ?>"><?php echo format_to_relative_time($proposal['date'], '', true); ?></td>
