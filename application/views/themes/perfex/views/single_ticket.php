...
<div class="row">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <hr class="hr-10" />
                        <p>
                            <?php echo _l('clients_ticket_single_submitted','<span class="pull-right bold">'.format_to_relative_time($ticket->date,'', false).'</span>'); ?>
                        </p>
                        <hr class="hr-10" />
                        <p>
    ...
    <div class="panel-footer">
        <span><?php echo _l('clients_single_ticket_replied',format_to_relative_time($reply['date'],'', false)); ?></span>
    </div>
</div>
<?php } ?>
</div>
