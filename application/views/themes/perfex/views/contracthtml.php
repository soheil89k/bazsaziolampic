            ...
            <div role="tabpanel" class="tab-pane<?php if(!$this->input->get('tab') || $this->input->get('tab') === 'summary'){echo ' active';} ?>" id="summary">
               ...
               <div class="row mtop20">
                  ...
                  <div class="col-md-7 contract-start-date">
                     <?php echo format_to_relative_time($contract->datestart, '', true); ?>
                  </div>
                  ...
                  <div class="col-md-7 contract-end-date">
                     <?php echo format_to_relative_time($contract->dateend, '', true); ?>
                  </div>
                  <?php } ?>
                  ...
                  <div class="col-md-7 contract-type">
                     <?php echo format_to_relative_time($contract->acceptance_date, '', false); ?>
                  </div>
                  <?php } ?>
               </div>
               ...
               <div class="row mtop20">
                  ...
                  <div class="col-md-7 contract-contract-signed-by">
                     <?php echo format_to_relative_time(explode(' ', $contract->acceptance_date)[0], '', true); ?>
                  </div>
