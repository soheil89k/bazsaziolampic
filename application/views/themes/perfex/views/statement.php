            ...
            <div class="form-group">
               ...
               <div class="row mtop15">
                  <div class="col-md-12 period<?php if(!$custom_period){echo ' hide';} ?>">
                     <?php
                     echo render_date_input('period-from','',($custom_period ? to_view_date_custom($from) : ''),array('onchange'=>'render_customer_statement();')); ?>
                  </div>
                  <div class="col-md-12 period<?php if(!$custom_period){echo ' hide';} ?>">
                  <?php echo render_date_input('period-to','',($custom_period ? to_view_date_custom($to) : ''),array('onchange'=>'render_customer_statement();')); ?>
                  </div>
               </div>
            </div>
            <div class="col-md-8">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-5">
                           <div class="text-right">
                              ...
                              <p class="text-muted"><?php echo _l('statement_from_to',array(format_to_relative_time($from,'',true),format_to_relative_time($to,'',true))); ?></p>
                              <hr />
                        ...
                        <div class="col-md-12">
                           <div class="text-center bold">
                              <p class="mbot20"><?php echo _l('customer_statement_info',array(format_to_relative_time($from,'',true),format_to_relative_time($to,'',true))); ?></p>
                           </div>
                           <div class="table-responsive">
                              <table class="table table-bordered table-striped">
                                 ...
                                 <tbody>
                                    <tr>
                                       <td><?php echo format_to_relative_time($from, '', true); ?></td>
                                    ...
                                    <tr>
                                       <td><?php echo format_to_relative_time($data['date'], '', true); ?></td>
                                       <td>
                                          <?php
                                          if(isset($data['invoice_id'])) {
                                             echo _l('statement_invoice_details',array('<a href="'.site_url('invoice/'.$data['invoice_id']).'/'.$data['hash'].'" target="_blank">'.format_invoice_number($data['invoice_id']).'</a>',format_to_relative_time($data['duedate'], '', true)));
