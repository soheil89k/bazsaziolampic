      ...
      <div class="container preview-sticky-container">
         <div class="row">
            <div class="col-md-12">
               ...
               <a href="#" class="btn btn-success pull-right mleft5 mtop5 action-button invoice-html-pay-now-top sticky-hidden
                  <?php if (($invoice->status != Invoices_model::STATUS_PAID && $invoice->status != Invoices_model::STATUS_CANCELLED
                     && $invoice->total > 0) && found_invoice_mode($payment_modes, $invoice->id, false)) {
                     echo ' pay-now-top';
                  } ?>">
   ...
   <div class="panel-body">
      <div class="col-md-10 col-md-offset-1">
         <div class="row mtop20">
            <div class="col-sm-6 text-right transaction-html-info-col-right" style="text-align: right;">
            ...
            <div class="col-md-6 col-sm-6 transaction-html-info-col-left" style="text-align: left;">
