         ...
         <table class="table dt-table table-projects" data-order-col="2" data-order-type="desc">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td data-order="<?php echo $project['start_date']; ?>"><?php echo format_to_relative_time($project['start_date'], '', true); ?></td>
                  <td data-order="<?php echo $project['deadline']; ?>"><?php echo format_to_relative_time($project['deadline'], '', true); ?></td>
                  <td>
                     <?php
