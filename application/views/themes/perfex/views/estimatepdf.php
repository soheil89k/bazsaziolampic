...
$estimate_info .= '<br />' . _l('estimate_data_date') . ': ' . format_to_relative_time($estimate->date, '', true) . '<br />';

if (!empty($estimate->expirydate)) {
    $estimate_info .= _l('estimate_data_expiry_date') . ': ' . format_to_relative_time($estimate->expirydate, '', true) . '<br />';
}
