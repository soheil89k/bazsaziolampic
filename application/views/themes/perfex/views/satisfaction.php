...
<input type="hidden" value="<?php echo $vuew; ?>" id="vuew" name="vuew">
<input type="hidden" value="<?php echo $client[0]['userid'] ?>" id="clinet" name="clinet">
...
<div class="row">
            ...
            <div class="row">
               ...
               <div class="col-md-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <p>با سلام <?php echo $client[0]['firstname'] ?> <?php echo $client[0]['lastname'] ?> عزیز خواهشمندیم انتقادات و پیشنهادات خود برای بهبود خدمات سرویس های ما در فراسیتی را با ما در میان بگذارید.</p>
                        <br />
                    </div>
   ...
   <div class="col-md-12 text-center mtop20">
       ...
       <script>
           function WiteSubmit(){
               $("#project-submit-form").submit();
               $("#submit").text("<?php echo _l('wait_text'); ?>");
           }
       </script>

      <button type="submit" class="btn btn-info" onclick="WiteSubmit()" id="submit"><?php echo _l('send'); ?></button>
