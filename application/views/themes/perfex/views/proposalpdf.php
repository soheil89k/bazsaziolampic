...
$proposal_date = _l('proposal_date') . ': ' . format_to_relative_time($proposal->date, '', true);
$open_till     = '';

if (!empty($proposal->open_till)) {
    $open_till = _l('proposal_open_till') . ': ' . format_to_relative_time($proposal->open_till, '', true) . '<br />';
}
