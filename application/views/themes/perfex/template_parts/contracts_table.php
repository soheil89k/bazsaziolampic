  ...
  <tbody>
    <?php foreach($contracts as $contract){
      ...
      <tr class="<?php echo $expiry_class; ?>">
       ...
       <td data-order="<?php echo $contract['datestart']; ?>"><?php echo format_to_relative_time($contract['datestart'], '', true); ?></td>
       <td data-order="<?php echo $contract['dateend']; ?>"><?php echo format_to_relative_time($contract['dateend'], '', true); ?></td>
