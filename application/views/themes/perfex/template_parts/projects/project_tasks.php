         ...
         <div class="panel-body">
            ...
            <div class="media _task_wrapper<?php if((!empty($task['duedate']) && $task['duedate'] < date('Y-m-d')) && $task['status'] != Tasks_model::STATUS_COMPLETE){ echo ' overdue-task'; } ?>">
               <div class="media-body">
                  ...
                  <br />
                  <small><?php echo _l('tasks_dt_datestart'); ?>: <b><?php echo format_to_relative_time($task['startdate'], '', true); ?></b></small>
                  <?php if(is_date($task['duedate'])){ ?>
                  -
                  <small><?php echo _l('task_duedate'); ?>: <b><?php echo format_to_relative_time($task['duedate'], '', true); ?></b></small>
                  <?php } ?>
               </div>
            </div>
            <?php } ?>
