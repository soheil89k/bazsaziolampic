    ...
    <tbody>
        <?php foreach($invoices as $invoice){ ?>
            <tr>
                ...
                <td data-order="<?php echo $invoice['date']; ?>"><?php echo format_to_relative_time($invoice['date'], '', true); ?></td>
                <td data-order="<?php echo $invoice['duedate']; ?>"><?php echo format_to_relative_time($invoice['duedate'], '', true); ?></td>
