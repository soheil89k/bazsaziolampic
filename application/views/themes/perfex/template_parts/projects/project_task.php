      ...
      <div class="col-md-12">
         <div class="row">
            <div class="col-md-9">
               ...
               <div class="task-info pull-left no-p-right">
               ...
               <div class="text-success task-info pull-left">
                  <h5 class="no-margin"><i class="fa fa-hourglass-start"></i>
                     <?php echo _l('task_single_start_date'); ?>: <?php echo format_to_relative_time($view_task->startdate, '', true); ?>
                  </h5>
               </div>
               <div class="task-info pull-left <?php if(!$view_task->status != Tasks_model::STATUS_COMPLETE){echo ' text-danger'; }else{echo 'text-info';} ?><?php if(!$view_task->duedate){ echo ' hide';} ?>">
                  <h5 class="no-margin"><i class="fa fa-hourglass-end"></i>
                     <?php echo _l('task_single_due_date'); ?>: <?php echo format_to_relative_time($view_task->duedate, '', true); ?>
                  </h5>
               </div>
               ...
               <div class="pull-left task-info text-success">
                  <h5 class="no-margin"><i class="fa fa-check"></i>
                     <?php echo _l('task_single_finished'); ?>: <?php echo format_to_relative_time($view_task->datefinished, false); ?>
                  </h5>
               </div>
               <?php } ?>
         ...
         <div class="mbot10 mtop10 task-comment" data-commentid="<?php echo $comment['id']; ?>" id="comment_<?php echo $comment['id']; ?>">
            ...
            <div class="media-body">
               ...
               <br />
               <?php } ?>
               <small class="mtop10 text-muted"><?php echo format_to_relative_time($comment['dateadded'], '', false); ?></small><br />
