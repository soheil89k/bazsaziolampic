    ...
    <tbody>
        <?php foreach($estimates as $estimate){ ?>
            <tr>
                ...
                <td data-order="<?php echo $estimate['date']; ?>"><?php echo format_to_relative_time($estimate['date'], '', true); ?></td>
                <td data-order="<?php echo $estimate['expirydate']; ?>"><?php echo format_to_relative_time($estimate['expirydate'], '', true); ?></td>
