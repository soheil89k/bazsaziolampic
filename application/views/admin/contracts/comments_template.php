...
<div class="col-md-12" data-commentid="<?php echo $comment['id']; ?>">
   ...
   <div class="media-body">
      ...
      <?php } ?>
      <small class="text-muted text-has-action" data-toggle="tooltip" data-title="<?php echo format_to_relative_time($comment['dateadded']); ?>"> - <?php echo time_ago($comment['dateadded']); ?></small>
      </div>
      <br />
