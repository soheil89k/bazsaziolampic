    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                ?>
                <?php
               echo render_date_input('new_start_date','contract_start_date',to_view_date_custom(date('Y-m-d'))); ?>
               <?php echo render_date_input('new_end_date','contract_end_date',to_view_date_custom($new_end_date_assume)); ?>
