					...
					<div class="panel-body">
						...
						<div class="row">
							...
							<div class="col-md-6">
								...
								<select name="cc" id="cc" class="form-control selectpicker" data-live-search="true" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>" data-width="100%">
