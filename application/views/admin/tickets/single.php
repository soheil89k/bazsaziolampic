               ...
               <div class="tab-content">
                                       ...
                                       <tbody>
                                          <?php foreach($ticket->ticket_notes as $note){ ?>
                                             <tr>
                                                ...
                                                <small class="bold">
                                                <?php echo _l('ticket_single_note_added',format_to_relative_time($note['dateadded'], false)); ?>
                                                </small>
                                             </td>
                                          </tr>
                                       <?php } ?>
                  ...
                  <div>
                     ...
                     <?php if($ticket->lastreply !== NULL){ ?>
                        <span class="ticket-label label label-success inline-block" data-toggle="tooltip" title="<?php echo format_to_relative_time($ticket->lastreply, false); ?>">
...
<div class="panel-footer">
   <?php echo _l('ticket_posted',format_to_relative_time($ticket->date, false)); ?>
</div>
</div>
...
<div class="panel-footer">
   <span><?php echo _l('ticket_posted',format_to_relative_time($reply['date'], false)); ?></span>
</div>
</div>
<?php } ?>
</div>
