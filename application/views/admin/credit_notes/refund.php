        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <?php
                    $p_start_date = isset($refund)? to_view_date_custom($refund->refunded_on) : to_view_date_custom(date('Y-m-d')); 
                    echo render_date_input('refunded_on', 'credit_date', $p_start_date); ?>
