                  ...
                  <div class="row">
                     ...
                     <div class="col-sm-6 text-right">
                        ...
                        <p class="no-mbot">
                           ...
                           <?php echo format_to_relative_time($credit_note->date, '', true)?>
                        </p>
               ...
               <table class="table table-bordered no-mtop">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           <?php echo format_to_relative_time($credit['date'], '', true); ?>
            ...
            <div role="tabpanel" class="tab-pane" id="tab_refunds">
               ...
               <table class="table table-bordered no-mtop">
                  ...
                  <tbody>
                     ...
                     <tr>
                        <td>
                           <?php echo format_to_relative_time($refund['refunded_on'],'' ,true); ?>
                        </td>
                        <td>
