					...
					<div class="col-md-12 no-padding">
						<div class="panel_s">
							...
							<div class="panel-body">
								...
								<?php
								$p_date = to_view_date_custom($payment->date);
								echo render_date_input('date','payment_edit_date',$p_date); ?>
					...
					<div class="panel-body">
						...
						<div class="row">
							...
							<div class="col-md-12 mtop30">
								<div class="row">
									<div class="col-md-6">
										<p><?php echo _l('payment_date'); ?> <span class="pull-right bold"><?php echo format_to_relative_time($payment->date, '', true); ?></span></p>
										<hr />
										...
										<thead>
											...
											<tbody>
												<tr>
													...
													<td><?php echo format_to_relative_time($payment->invoice->date, '', true); ?></td>
