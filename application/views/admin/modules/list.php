                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <p class="font-medium">اگر ماژولی با فرمت.zip دارید, با آپلود در اینجا می توانید آن را نصب کنید.</p>
                        </div>
                        <div class="col-md-4 col-md-offset-4">
                            <label for="module" class="control-label">آپلود ماژول</label>
                            <div class="input-group">
                                <input type="file" class="form-control" name="module">
                                <span class="input-group-btn">
                                    <button class="btn btn-default p8" type="submit">نصب</button>
                                </span>
                            </div><!-- /input-group -->
                        </div><!-- /.col-md-6 -->
                    </div>
