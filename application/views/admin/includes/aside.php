...
<aside id="menu" class="sidebar">
   <ul class="nav metis-menu" id="side-menu">
      ...
      <?php } ?>
      <?php if($this->app->show_setup_menu() == true && (is_staff_member() || is_admin()) || 1){ ?>
      ...
      <li class="menu-item-custom-settings">
         <a href="<?php echo admin_url('custom_settings') ?>">
         <i class="fa fa-unlock menu-icon"></i>
                <span class="menu-text">
                <?php echo _l('custom_settings'); ?></span>
        </a>
      </li>
