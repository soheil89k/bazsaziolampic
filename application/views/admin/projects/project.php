            ...
            <div class="col-md-7">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        $p_start_date = isset($project)? to_view_date_custom($project->start_date) : to_view_date_custom(date('Y-m-d')); 
                        ?>
                        <?php echo render_date_input('start_date','project_start_date',$p_start_date); ?>
                    </div>
                    <div class="col-md-6">
                        <?php $value = (isset($project) ? _d($project->deadline) : ''); 
                        $p_end_date = isset($project)? to_view_date_custom($project->deadline) : '';
                        ?>
                        <?php echo render_date_input('deadline','project_deadline',$p_end_date); ?>
                    </div>
                </div>
