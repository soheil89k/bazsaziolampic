...
<div class="activity-feed">
    <?php foreach($activity as $activity){
        ...
        <div class="feed-item">
            <div class="row">
                <div class="col-md-8">
                 <div class="date"><span class="text-has-action" data-toggle="tooltip" data-title="<?php echo format_to_relative_time($activity['dateadded'], '', false); ?>"><?php echo time_ago($activity['dateadded']); ?></span></div>
                 <div class="text">
                  <?php
