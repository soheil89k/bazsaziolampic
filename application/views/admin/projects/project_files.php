      ...
      <tr>
        ...
        <td data-order="<?php echo $file['file_name']; ?>">
          ...
          <td data-order="<?php echo $file['last_activity']; ?>">
            ...
            <span class="text-has-action" data-toggle="tooltip" data-title="<?php echo format_to_relative_time($file['last_activity'], false); ?>">
         ...
         <td data-order="<?php echo $file['dateadded']; ?>"><?php echo format_to_relative_time($file['dateadded'], false); ?></td>
         <td>
