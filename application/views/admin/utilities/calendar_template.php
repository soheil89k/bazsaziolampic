      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-md-12">
            ...
            <?php echo custom_render_date_input('start','utility_calendar_new_event_start_date'); ?>
            <div class="clearfix mtop15"></div>
            <?php echo custom_render_date_input('end','utility_calendar_new_event_end_date'); ?>
