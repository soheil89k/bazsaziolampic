   ...
   <div class="row">
      ...
      <div class="col-md-12">
         <?php if(total_rows(db_prefix().'departments',array('email'=>$member->email)) > 0) { ?>
            ...
            برخی از ایمیل های استفاده شده برای دپارتمان ها با ایمیل کارمند مشترک است. طبق مستندات ایمیل دپارتمان پشتیبانی باید منحصر به فرد باشد. باید ایمیل کارمند یا دپارتمان پشتیبانی را تغییر دهید تا همه امکانات سیستم به درستی کار کنند.
            </div>
         <?php } ?>
         <div class="panel_s">
            <div class="panel-body">
               <h4 class="no-margin"><?php echo $member->firstname . ' ' . $member->lastname; ?>
                  ...
                  <small> - <?php echo _l('last_active'); ?>:
                        <span class="text-has-action" data-toggle="tooltip" data-title="<?php echo format_to_relative_time($member->last_activity, false); ?>">
            ...
            <div class="panel-body">
               ...
               <div class="tab-content">
                  <div role="tabpanel" class="tab-pane active" id="tab_staff_profile">
                     ...
                     <span class="text-has-action" data-toggle="tooltip" data-title="<?php echo format_to_relative_time($member->last_password_change, false); ?>">
                  ...
                  <table class="table dt-table" data-order-col="2" data-order-type="desc">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td data-order="<?php echo $note['dateadded']; ?>"><?php echo format_to_relative_time($note['dateadded'], false); ?></td>
                           <td>
                  ...
                  <table class="table dt-table">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td data-order="<?php echo $t['start_time']; ?>"><?php echo format_to_relative_time(_dt($t['start_time'], true), '', true); ?></td>
                           <td data-order="<?php echo $t['end_time']; ?>">
                              <?php
                                 ...
                                 if($t['not_finished'] && (is_admin() || $t['staff_id'] === get_staff_user_id())) {
                                    ...
                                    echo format_to_relative_time(_dt($t['end_time'], true), '', true);
                                 }
                              ?>
                           </td>
                           <td>
