            ...
            <div class="panel_s">
               <div class="panel-body">
                  ...
                  <?php $value = (isset($expense) ? _d($expense->date) : _d(date('Y-m-d')));
                   $p_date = isset($expense)? to_view_date_custom($expense->date) : to_view_date_custom(date('Y-m-d')); 
                     $date_attrs = array();
                     if(isset($expense) && $expense->recurring > 0 && $expense->last_recurring_date != null) {
                       $date_attrs['disabled'] = true;
                     }
                     ?>
                  <?php echo render_date_input('date','expense_add_edit_date',$p_date,$date_attrs);
