   ...
   <div class="row">
      <div class="col-md-12">
               ...
               <div class="horizontal-tabs">
                  <ul class="nav-tabs-horizontal nav nav-tabs<?php if(!isset($lead)){echo ' lead-new';} ?>" role="tablist">
                     ...
                     <li role="presentation">
                        <a href="#tab_lead_whatsapp" aria-controls="tab_lead_whatsapp" role="tab" data-toggle="tab">
                        <?php echo _l('whatsapp_send_coustomerـin'); ?>
                        </a>
                     </li>
                     <?php if(isset($lead)){ ?>
         ...
         <div class="tab-content mtop20">
            ...
            <div role="tabpanel" class="tab-pane" id="tab_lead_whatsapp">
               <?php $this->load->view('admin/leads/whatsapp'); ?>
            </div>
            <?php if(isset($lead)){ ?>
            <?php if(count($mail_activity) > 0 || isset($show_email_activity) && $show_email_activity){ ?>
               ...
               <div class="lead-email-activity">
                  ...
                  <div class="media-body">
                     <h4 class="bold no-margin lead-mail-activity-subject">
                        ...
                        <br />
                        <small class="text-muted display-block mtop5 font-medium-xs"><?php echo format_to_relative_time($_mail_activity['dateadded'], '', false); ?></small>
                     </h4>
            ...
            <div role="tabpanel" class="tab-pane" id="lead_activity">
               <div class="panel_s no-shadow">
                  <div class="activity-feed">
                     ...
                     <div class="feed-item">
                        <div class="date">
                           <span class="text-has-action" data-toggle="tooltip" data-title="<?php echo format_to_relative_time($log['date'], '', false); ?>">
            ...
            <div role="tabpanel" class="tab-pane" id="lead_notes">
               ...
               <div class="lead-select-date-contacted hide">
                  <?php
            $p_date = to_view_date_custom(date('Y-m-d'));  
            echo render_datetime_input('custom_contact_date','lead_add_edit_datecontacted','',array('data-date-end-date'=>$p_date)); ?>
               </div>
               ...
               <div class="panel_s no-shadow">
                  ...
                  <div class="media lead-note">
                     ...
                     <div class="media-body">
                        ...
                        <span data-toggle="tooltip" data-title="<?php echo format_to_relative_time($note['date_contacted'], false); ?>">
                        <i class="fa fa-phone-square text-success font-medium valign" aria-hidden="true"></i>
                        </span>
                        <?php } ?>
                        <small><?php echo _l('lead_note_date_added',format_to_relative_time($note['dateadded'], false)); ?></small>
                        <a href="<?php echo admin_url('profile/'.$note["addedfrom"]); ?>" target="_blank">
