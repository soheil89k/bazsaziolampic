...
foreach ($rResult as $aRow) {
    ...
    $row[] = (!empty($aRow['last_login']) ? '<span class="text-has-action is-date" data-toggle="tooltip" data-title="' . format_to_relative_time($aRow['last_login'], '', false) . '">' . time_ago($aRow['last_login']) . '</span>' : '');
