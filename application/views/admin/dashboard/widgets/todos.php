            ...
            <?php foreach($todos as $todo) { ?>
               ...
               <div class="media-body">
                  <p class="todo-description read-more no-padding-left" data-todo-description="<?php echo $todo['todoid']; ?>">
                        ...
                        <small class="todo-date"><?php echo format_to_relative_time($todo['dateadded'], '', false); ?></small>
               </div>
            </div>
         </li>
      <?php } ?>
      ...
      <?php foreach($todos_finished as $todo_finished){ ?>
         <li>
            ...
            <div class="media-body">
               ...
               <small class="todo-date todo-date-finished"><?php echo format_to_relative_time($todo_finished['datefinished'], '', false); ?></small>
            </div>
         </div>
      </li>
   <?php } ?>
