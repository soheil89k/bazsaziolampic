                ...
                <div class="row">
                    ...
                    <div class="client_password_set_wrapper">
                        ...
                        <?php if($contact->last_password_change != NULL){
                            ...
                            echo '<span class="text-has-action" data-toggle="tooltip" data-title="'.format_to_relative_time($contact->last_password_change, '', false).'"> ' . time_ago($contact->last_password_change) . '</span>';
                        }
                    } ?>
                </div>
                <hr />
