...
<div class="col-md-12">
  <div class="text-center bold padding-10">
    <?php echo _l('customer_statement_info',array(format_to_relative_time($from,'',true),format_to_relative_time($to,'',true))); ?>
  </div>
         ...
         <tr>
           ...
           <td>
            ...
            if(isset($data['invoice_id'])) {
              echo _l('statement_invoice_details',array('<a href="'.admin_url('invoices/list_invoices/'.$data['invoice_id']).'" target="_blank">'.format_invoice_number($data['invoice_id']).'</a>',format_to_relative_time($data['duedate'],'', true)));
