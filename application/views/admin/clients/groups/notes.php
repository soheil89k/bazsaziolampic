    ...
    <table class="table dt-table" data-order-col="2" data-order-type="desc">
        ...
        <td data-order="<?php echo $note['dateadded']; ?>">
         <?php if(!empty($note['date_contacted'])){ ?>
           <span data-toggle="tooltip" data-title="<?php echo html_escape(format_to_relative_time($note['date_contacted'], '', false)); ?>">
              <i class="fa fa-phone-square text-success font-medium valign" aria-hidden="true"></i>
          </span>
          <?php } ?>
          <?php echo format_to_relative_time($note[ 'dateadded'], '', false); ?>
        </td>
        <td>
