                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <?php if ((isset($client) && empty($client->website)) || !isset($client)) {
                            ...
                            <?php $client_type_list = get_client_type();
                            $customer_default_type = get_option('customer_default_type');
                            $selected = (isset($client) ? $client->clientType : $customer_default_type);
                            echo render_select('clientType', $client_type_list, array('id', array('name')), 'clientType', $selected, array('data-none-selected-text' => _l('dropdown_non_selected_tex')));
                            ?>
                    ...
                    <table class="table dt-table">
                        ...
                        <?php foreach ($customer_admins as $c_admin) { ?>
                            <tr>
                                ...
                                <td data-order="<?php echo $c_admin['date_assigned']; ?>"><?php echo format_to_relative_time($c_admin['date_assigned'], '', false); ?></td>
                                <?php if (has_permission('customers', '', 'create') || has_permission('customers', '', 'edit')) { ?>
                                    <td>
