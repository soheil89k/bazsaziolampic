         ...
         <div class="row mtop10">
            ...
            <div class="col-md-9">
               ...
               <div class="pull-right _buttons">
                  ...
                  <?php } ?>
                  <?php } else { ?>
                  <a href="<?php echo admin_url('invoices/list_invoices/'.$estimate->invoice->id); ?>" data-placement="bottom" data-toggle="tooltip" title="<?php echo _l('estimate_invoiced_date',format_to_relative_time($estimate->invoiced_date), false); ?>"class="btn mleft10 btn-info"><?php echo format_invoice_number($estimate->invoice->id); ?></a>
                  <?php } ?>
               </div>
            </div>
         </div>
         ...
         <div class="tab-content">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-12">
                        <div class="alert alert-info mbot15">
                           <?php echo _l('accepted_identity_info',array(
                              ...
                              '<b>'. format_to_relative_time($estimate->acceptance_date, false).'</b>',
                     ...
                     <div class="col-sm-6 text-right">
                        ...
                        <p class="no-mbot">
                           ...
                           <?php echo format_to_relative_time($estimate->date, '', true); ?>
                        </p>
                        <?php if(!empty($estimate->expirydate)){ ?>
                        <p class="no-mbot">
                           <span class="bold"><?php echo _l('estimate_data_expiry_date'); ?>:</span>
                           <?php echo format_to_relative_time($estimate->expirydate, '', true); ?>
                        </p>
                        <?php } ?>
                  ...
                  <div class="col-md-12">
                     <div class="activity-feed">
                        ...
                        <div class="feed-item" data-sale-activity-id="<?php echo $activity['id']; ?>">
                           <div class="date">
                              <span class="text-has-action" data-toggle="tooltip" data-title="<?php echo format_to_relative_time($activity['date'], '', false); ?>">
            ...
            <div role="tabpanel" class="tab-pane" id="tab_views">
               ...
               <p class="text-success no-margin">
                  <?php echo _l('view_date') . ': ' . format_to_relative_time($activity['date'], false); ?>
               </p>
               <p class="text-muted">
