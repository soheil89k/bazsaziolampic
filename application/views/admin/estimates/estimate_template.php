         ...
         <div class="col-md-6">
            ...
            <div class="row">
               <div class="col-md-6">
                  ...
                  $p_date = isset($estimate)? to_view_date_custom($estimate->date) : to_view_date_custom(date('Y-m-d')); 
                  ?>
                  <?php echo render_date_input('date','estimate_add_edit_date',$p_date); ?>
               </div>
               <div class="col-md-6">
                  <?php
                  $value = '';
                  if(isset($estimate)){
                    ...
                    $p_expirydate = to_view_date_custom($estimate->expirydate);
                  } else {
                      if(get_option('estimate_due_after') != 0){
                          $value = _d(date('Y-m-d', strtotime('+' . get_option('estimate_due_after') . ' DAY', strtotime(date('Y-m-d')))));
                          $p_expirydate = to_view_date_custom(date('Y-m-d', strtotime('+' . get_option('estimate_due_after') . ' DAY', strtotime(date('Y-m-d'))))); 
                      }
                  }
                  echo render_date_input('expirydate','estimate_add_edit_expirydate',$p_expirydate); ?>
               </div>
            </div>
