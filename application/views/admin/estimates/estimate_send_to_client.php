			...
			<div class="modal-body">
				<div class="row">
					<div class="col-md-12">
						...
						<hr />
						<?php echo render_textarea('email_template_custom','','کاربر گرامي :  {contact_firstname} {contact_lastname}

صورتحساب جدیدی برای شما ایجاد شده است.
لطفا برای جلوگیری از انسداد و وقوع مشکل این صورتحساب را پرداخت کنید.
در صورت عدم پرداخت صورتحساب تا تاریخ سررسید ، سرویس مرتبط مسدود و پس از 24 ساعت حذف می گردد.

شماره صورتحساب : {estimate_number}
مبلغ صورتحساب : {estimate_subtotal}
تاریخ صدور صورتحساب : {estimate_date}
تاریخ سررسید صورتحساب : {estimate_expirydate}
لینک پرداخت صورتحساب : {estimate_link}

با سپاس شرکت فراسیتی',array(),array(),'',''); ?>
