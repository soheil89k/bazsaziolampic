         ...
         <div class="col-md-12">
            <div class="row">
               <div class="col-md-8">
                  ...
                  <br />
                  <?php echo _l('estimate_data_date') . ': ' . format_to_relative_time($estimate['date'], '', true); ?>
                  <?php if(is_date($estimate['expirydate']) || !empty($estimate['expirydate'])){
                     echo '<br />';
                     echo _l('estimate_data_expiry_date') . ': ' . format_to_relative_time($estimate['expirydate'], '', true);
                     } ?>
               </div>
