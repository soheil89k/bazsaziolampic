            ...
            <div class="col-md-7">
                <div class="panel_s">
                    <div class="panel-body tc-content">
                      ...
                      <p class="text-muted mtop10 no-mbot"><?php echo _l('announcement_date',format_to_relative_time($announcement->dateadded, false)); ?></p>
            ...
            <div class="panel_s">
                <div class="panel-body">
                    ...
                    <a class="bold" href="<?php echo admin_url('announcements/view/'.$announcement['announcementid']); ?>">
                        ...
                        <p class="text-muted no-margin"><?php echo _l('announcement_date',format_to_relative_time($announcement['dateadded'], false)); ?></p>
                        <?php if($announcement['showname'] == 1){ ?>
                        <p class="text-muted no-margin"><?php echo _l('announcement_from') . ' ' . $announcement['userid']; ?></p>
                        <?php } ?>
                        <div class="mtop15">
