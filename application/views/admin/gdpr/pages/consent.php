...
<?php render_yes_no_option('gdpr_enable_consent_for_contacts','فعال کردن توافق برای مخاطبین'); ?>
<hr />
<?php render_yes_no_option('gdpr_enable_consent_for_leads','فعال کردن توافق برای مشتریان بالقوه'); ?>
<hr />
<p class="">
    بلوک اطلاعات صفحه توافق عمومی
</p>
...
<hr class="hr-panel-heading" />
<button type="button" class="btn btn-info pull-left mright10" onclick="conset_purpose(); return false;" data-toggle="tooltip" title="هدف جدید توافق"><i class="fa fa-plus-square-o"></i></button>
<h4 class="mbot30 mtop7 pull-left">اهداف توافق</h4>
