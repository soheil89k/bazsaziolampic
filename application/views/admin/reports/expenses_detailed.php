            ...
            <div class="col-md-12">
                ...
                <div class="panel_s">
                            ...
                            <div class="row">
                             <div class="col-md-6">
                              ...
                              <div class="input-group date">
                               <input type="text" class="form-control datepicker" data-targetselector="#report-from" id="report-from" name="report-from">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="input-group date">
                       <input type="text" class="form-control datepicker" data-targetselector="#report-to"  disabled="disabled" id="report-to" name="report-to">
                       <div class="input-group-addon">
                        <i class="fa fa-calendar calendar-icon"></i>
                    </div>
                </div>
