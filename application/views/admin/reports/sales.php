                  ...
                  <div id="currency" class="form-group hide">
                     ...
                     <div id="income-years" class="hide mbot15">
                        ...
                        <select class="selectpicker" name="payments_years" data-width="100%" onchange="total_income_bar_report();" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                           ...
                           <option value="<?php echo $year['year']; ?>"<?php if($year['year'] == date('Y')){echo 'selected';} ?>>
                              <?php echo $this->jdf->jdate('Y', convert_datetime(convert_date_utc_to_local($year['year']))); ?>
                           </option>
                           <?php } ?>
                        </select>
                     </div>
                     <div class="form-group hide" id="report-time">
                        ...
                        <select class="selectpicker" name="months-report" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                           ...
                           <option value="3" data-subtext="<?php echo format_to_relative_time(date('Y-m-01', strtotime("-2 MONTH")), '', true); ?> - <?php echo format_to_relative_time(date('Y-m-t'), '', true); ?>"><?php echo _l('report_sales_months_three_months'); ?></option>
                           <option value="6" data-subtext="<?php echo format_to_relative_time(date('Y-m-01', strtotime("-5 MONTH")), '', true); ?> - <?php echo format_to_relative_time(date('Y-m-t'), '', true); ?>"><?php echo _l('report_sales_months_six_months'); ?></option>
                           <option value="12" data-subtext="<?php echo format_to_relative_time(date('Y-m-01', strtotime("-11 MONTH")), '', true); ?> - <?php echo format_to_relative_time(date('Y-m-t'), '', true); ?>"><?php echo _l('report_sales_months_twelve_months'); ?></option>
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              ...
                              <div class="input-group date">
                                 <input type="text" class="form-control datepicker" autocomplete="off" data-targetselector="#report-from" id="report-from" name="report-from">
                           ...
                           <div class="col-md-6">
                              ...
                              <div class="input-group date">
                                 <input type="text" class="form-control datepicker" autocomplete="off" data-targetselector="#report-to" disabled="disabled" id="report-to" name="report-to">
                                 <div class="input-group-addon">
                                    <i class="fa fa-calendar calendar-icon"></i>
                                 </div>
                              </div>
