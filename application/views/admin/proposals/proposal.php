                     ...
                     <div class="col-md-6 border-right">
                        ...
                        <div class="row">
                          <div class="col-md-6">
                              ...
                              $p_date = isset($proposal)? to_view_date_custom($proposal->date) : to_view_date_custom(date('Y-m-d'));
                              ?>
                              <?php echo render_date_input('date','proposal_date',$p_date); ?>
                          </div>
                          <div class="col-md-6">
                            <?php
                        $value = '';
                        if(isset($proposal)){
                          ...
                          $p_open_till = to_view_date_custom($proposal->open_till); 
                        } else {
                          if(get_option('proposal_due_after') != 0){
                              $value = _d(date('Y-m-d',strtotime('+'.get_option('proposal_due_after').' DAY',strtotime(date('Y-m-d')))));
                              $p_open_till = to_view_date_custom(date('Y/m/j', strtotime('+' . get_option('proposal_due_after') . ' DAY', strtotime(date('Y/m/j'))))); 
                          }
                        }
                        echo render_date_input('open_till','proposal_open_till',$p_open_till); ?>
                          </div>
                        </div>
                        <?php
                           $selected = '';
