         ...
         <div class="col-md-12">
            <div class="row">
               <div class="col-md-8">
                  ...
                  <br />
                  <?php } ?>
                  <?php echo _l('proposal_date'); ?>: <?php echo format_to_relative_time($proposal['date'], '', true); ?>
                  <?php if(is_date($proposal['open_till'])){ ?>
                  <br />
                  <?php echo _l('proposal_open_till'); ?>: <?php echo format_to_relative_time($proposal['open_till'], '', true); ?>
                  <?php } ?>
                  <br />
               </div>
