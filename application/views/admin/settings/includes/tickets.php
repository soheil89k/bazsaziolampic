...
<div class="tab-content mtop30">
  ...
  <div role="tabpanel" class="tab-pane" id="ticket_form">
    ...
    <p><b>محل فایل فرم :</b> <code><?php echo hooks()->apply_filters('ticket_form_file_location_settings', VIEWPATH.'forms\ticket.php'); ?></code></p>
    <hr />
    <h4 class="bold font-medium">قرار دادن فرم</h4>
    ...
    <h4 class="mtop15 font-medium bold">لینک مستقیم به اشتراک بگذارید</h4>
    <p>
      <span class="label label-default">
    ...
    <hr />
    <p class="bold mtop15">هنگام قرار دادن کد قطعه iframe موارد زیر را در نظر بگیرید:</p>
    <p class="<?php if(strpos(site_url(),'http://') !== false){echo 'bold text-success';} ?>">1. اگر پروتکل نصب شما http است از یک صفحه http در داخل iframe استفاده کنید.</p>
    <p class="<?php if(strpos(site_url(),'https://') !== false){echo 'bold text-success';} ?>">2. اگر پروتکل نصب شما https است از یک صفحه https در داخل iframe استفاده کنید.</p>
    <p>نصب غیر SSL باید پیوند را در معادل غیر ssl قرار دهد. صفحه فرود و عقب.</p>
    <hr />
    <h4 class="bold">تغییر ستون ظرف فرم (Bootstrap)</h4>
    <p>
      <span class="label label-default">
