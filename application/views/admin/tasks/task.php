               ...
               <div class="row">
                  <div class="col-md-6">
                     <?php if(isset($task)){
                         ...
                         $value = $start_date;
                         $p_date = to_view_date_custom($start_date);
                         } else {
                         $value = _d(date('Y-m-d'));
                        ...
                        ?>
                     <?php echo render_date_input('startdate','task_add_edit_start_date',$p_date, $date_attrs); ?>
                  </div>
                  <div class="col-md-6">
                     <?php $value = (isset($task) ? _d($task->duedate) : '');
                     $p_duedate = (isset($task) ? to_view_date_custom($task->duedate) : '');
                     ?>
                     <?php echo render_date_input('duedate','task_add_edit_due_date',$p_duedate,$project_end_date_attrs); ?>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group">
