                  ...
                  <div class="row">
                     ...
                     <div class="col-md-2 border-right">
                        <?php
                           ...
                           for ($m = 1; $m <= 12; $m++) {
                             $data = array();
                             $data['month'] = $m;
                             $data['name'] = _l($this->jdf->jdate('F', mktime(0, 0, 0, $m, 1)));
                             $months[] = $data;
                           }
                     ...
                     <div class="col-md-2 border-right select-placeholder">
                        <select name="year" id="year" class="selectpicker no-margin" data-width="100%">
                           ...
                           <option value="<?php echo $data['year']; ?>" <?php if($this->input->post('year') == $data['year'] || date('Y') == $data['year']){echo 'selected'; } ?>><?php echo $this->jdf->jdate('Y',convert_datetime(convert_date_utc_to_local($data['year']))); ?></option>
                           <?php } ?>
                        </select>
                     </div>
                     <div class="col-md-2">
                  ...
                  <table class="table tasks-overview dt-table">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td data-order="<?php echo $task['startdate']; ?>"><?php echo format_to_relative_time($task['startdate'], '', true); ?></td>
                           <td data-order="<?php echo $task['duedate']; ?>"><?php echo format_to_relative_time($task['duedate'], '', true); ?></td>
