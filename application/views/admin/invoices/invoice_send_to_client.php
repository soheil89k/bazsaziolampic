                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            echo render_select('sent_to[]', $contacts, array('id','phonenumber','firstname,lastname'), 'invoice_estimate_sent_to_email',$selected, array('multiple'=>true), array(), '', '', false);
                            ?>
                        </div>
                        <hr />
                    ...
                    <hr />
                    <?php echo render_textarea('email_template_custom', '', 'کاربر گرامی 
{contact_lastname} {contact_firstname}
بدینوسیله به اطلاع شما می رساند جهت ادامه همکاری و استفاده از خدمات شرکت نسبت به پرداخت فاکتور {invoice_number} هزینه پنل مصرفی خود اقدام نمایید.
شماره کارت 
6037701526243289
به نام :
(امیرحسین صدیق فراستی)
همچنین شما میتوانید از طریق لینک زیر وجه مربوطه را به صورت آنلاین پرداخت نمایید
شرکت فراسیتی
باتشکر
لینک : {invoice_link}', [], [], '', ''); ?>
