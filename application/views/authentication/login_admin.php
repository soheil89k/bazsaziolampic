...
<body class="login_admin"<?php if(is_rtl()){ echo ' dir="rtl"'; } ?>>
 <div class="container">
  <div class="row">
   <div class="col-md-4 col-md-offset-4 col-sm-8 col-sm-offset-2 authentication-form-wrapper">
    ...
    <div class="mtop40 authentication-form">
      <h1 style="margin-top: 0;"><?php get_company_logo(); ?></h1>
  ...
  <div class="col-md-4 col-md-offset-4 col-sm-8 col-sm-offset-2" style="margin-top: 20px;">
    <div class="authentication-form text-center">
