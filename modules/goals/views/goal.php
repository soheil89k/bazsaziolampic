                ...
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <?php $value = (isset($goal) ? _d($goal->start_date) : _d(date('Y-m-d')));
                         $p_date = isset($goal)? to_view_date_custom($goal->start_date) : to_view_date_custom(date('Y-m-d')); 
                        ?>
                        <?php echo render_date_input('start_date','goal_start_date',$p_date); ?>
                        <?php $value = (isset($goal) ? _d($goal->end_date) : '');
                        $p_date = isset($goal)? to_view_date_custom($goal->end_date) : '';
                        ?>
                        <?php echo render_date_input('end_date','goal_end_date',$p_date); ?>
