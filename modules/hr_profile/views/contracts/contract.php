				...
				<div class="modal-body">
					...
					<div class="tab-content">
						...
						<div class="row">
							<div class="col-md-6">
								<?php
								$start_valid = (isset($contracts) ? $contracts->start_valid : convert_datetime(date('Y/m/d')));
						...
						<div class="row">
							<div class="col-md-6">
								<?php
								$sign_day = (isset($contracts) ? $contracts->sign_day : to_view_date_custom(date('Y-m-d')));
