        ...
        <div class="panel-body">
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="row">
                <div class="col-md-6"> 
                  <?php $value = (isset($commission_policy) ? to_view_date_custom($commission_policy->from_date) : ''); ?>
                  <?php echo render_date_input('from_date','from_date',$value); ?>
                </div>
                <div class="col-md-6">
                  <?php $value = (isset($commission_policy) ? to_view_date_custom($commission_policy->to_date) : ''); ?>
