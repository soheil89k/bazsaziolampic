...
foreach ($rResult as $aRow) {
    ...
    $row[] = to_view_date_custom($aRow[db_prefix().'timesheets_requisition_leave.start_time']);  
    $row[] = to_view_date_custom($aRow[db_prefix().'timesheets_requisition_leave.end_time']);  
...
$row[] = to_view_date_custom(date('Y-m-d', strtotime($aRow[db_prefix().'timesheets_requisition_leave.datecreated'])));  
