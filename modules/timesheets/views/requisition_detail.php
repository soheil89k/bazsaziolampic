                  ...
                  <table class="table table-striped">
                    <tbody>
                      <tr>
                        ...
                        echo to_view_date_custom($datecreated); ?></td>
                      </tr>
                      <tr>
                        ...
                        <?php if($request_leave->rel_type == 1){ ?>
                          <td>
                            ...
                            if(strtotime($request_leave->start_time) == strtotime($request_leave->end_time)){
                              echo to_view_date_custom(date('Y-m-d', strtotime($request_leave->start_time)));                              
                            }
                            else{
                              echo to_view_date_custom(date('Y-m-d', strtotime($request_leave->start_time))).' - '.to_view_date_custom(date('Y-m-d', strtotime($request_leave->end_time)));                               
                            }
                            ?>
                          </td>
                        <?php }
                          ...
                          <td>
                            <?php
                            if(strtotime($request_leave->start_time) == strtotime($request_leave->end_time)){
                              echo to_view_date_time_custom(date('Y-m-d H:i:s', strtotime($request_leave->start_time)));                              
                            }
                            else{
                              echo to_view_date_time_custom(date('Y-m-d H:i:s', strtotime($request_leave->start_time))).' - '.to_view_date_time_custom(date('Y-m-d H:i:s', strtotime($request_leave->end_time)));                               
                            }
                            ?>
                          </td>
                        <?php }
                          ...
                          { ?>
                            <td><?php echo to_view_date_time_custom($request_leave->start_time) ?></td>
                          <?php  } ?>
                        </tr>
                  ...
                  if($request_leave->rel_type == 4 && count($advance_payment) > 0){ ?>
                    <div class="col-md-6">
                      ...
                      <table class="table table-striped">  
                        ...
                        <tr>
                          ...
                          <td id="request_date"><?php echo to_view_date_custom($advance_payment[0]['request_date']); ?></td>
                        </tr>
                      </tbody>
                    ...
                    <?php if($request_leave->status == 1){  ?>
                      <div class="row">
                        ...
                        <div class="col-lg-4">
                          <?php $received_date = (isset($request_leave) ? to_view_date_custom($request_leave->received_date): '');
                  ...
                  foreach ($list_approve_status as $value) { 
                    ...
                    <div class="col-md-3 text-center">
                     <p class="text-uppercase text-muted no-mtop bold">
                      ...
                      <?php } ?>
                      <br><br>  
                      <p class="bold text-center text-<?php if($value['approve'] == 1){ echo 'success'; }elseif($value['approve'] == 2){ echo 'danger'; } ?>"><?php echo to_view_date_time_custom($value['date']); ?></p> 
...
<div class="modal fade" id="convert_expense" tabindex="-1" role="dialog">
 <div class="modal-dialog">
  ...
  ?>
  <?php echo render_date_input('date','expense_add_edit_date',to_view_date_custom(date('Y-m-d'))); ?>
