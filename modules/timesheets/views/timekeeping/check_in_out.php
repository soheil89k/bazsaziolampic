            ...
            <div class="row">
              <div class="col-md-12">
                ...
                foreach ($data_check_in_out as $key => $value) {
                  ...
                  $html_list .= '<div class="row"><div class="col-md-12"><div class="alert '.$alert_type.'">'.$type_check.': '.to_view_date_custom($value['date']).'</div></div></div>';
                } ?>
                <?php 
                ...
                <div class="row curr_date_attendance_wrap">
                  <div class="curr_date text-center" id="curr_date_attendance">
                    <?php echo to_view_date_custom(date('Y-m-d')); ?>
                    <?php
                    if($allows_updating_check_in_time == 1 || is_admin()){ ?>
                      ...
                      if($allows_to_choose_an_older_date == 1 || is_admin())
                      {
                        ...
                        $attr = array('onchange' => 'changedate(this)',
                         'data-date-min-date'=> to_view_date_custom(date('Y-m-d H:i:s')));
                      }
