...
$staff = [];
$date_create = '';
$from_date = to_view_date_custom(date('Y-m').'-01');
$to_date = to_view_date_custom(date('Y-m').'-31');
$type_shiftwork = '';
...
if(isset($word_shift)){
  ...
  $from_date = to_view_date_custom($word_shift->from_date);
  $to_date = to_view_date_custom($word_shift->to_date);
