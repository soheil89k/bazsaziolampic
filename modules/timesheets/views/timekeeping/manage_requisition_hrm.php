      ...
      <div class="form">
        ...
        <div class="row mtop10 date_input">
          <div class="col-md-6 start_time">
            <?php echo render_date_input('start_time','From_Date', to_view_date_custom(date('Y-m-d'))) ?>
          </div>
          <div class="col-md-6 end_time">
            <?php echo render_date_input('end_time','To_Date', to_view_date_custom(date('Y-m-d'))) ?>
          </div>
        </div>

        <div class="row mtop10 datetime_input hide">
          <div class="col-md-6 start_time">
            <?php echo render_datetime_input('start_time_s','From_Date',to_view_date_time_custom(date('Y-m-d H:i:s'))) ?>
          </div>
          <div class="col-md-6 end_time">
            <?php echo render_datetime_input('end_time_s','To_Date',to_view_date_time_custom(date('Y-m-d H:i:s'))) ?>
          </div>
        </div>
